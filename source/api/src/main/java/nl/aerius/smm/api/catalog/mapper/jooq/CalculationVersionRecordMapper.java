...
public interface CalculationVersionRecordMapper {

  CalculationVersion toDomain(CalculationVersionsRecord record);

  CalculationVersionsRecord toRecord(CalculationVersion domain);
}
